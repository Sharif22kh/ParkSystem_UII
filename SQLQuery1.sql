...
/* 5. CREATE THE BOOKINGS TABLE (with Foreign Keys) */
...
/* 6. POPULATE TABLES WITH THE CORRECT SAMPLE DATA */
...
/* 7. SAMPLE BOOKING: Sharif (VisitorID 1) books the Kiwi Tour (EventID 1) */
